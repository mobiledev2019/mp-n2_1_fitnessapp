...
//        ex_image.setImageResource(list.get(id).getIdImage());
    ...
    public void sansang(){
        tts.speak("Sẵn sàng", TextToSpeech.QUEUE_FLUSH, null); }
    public void chuanbi(){
        tts.speak("Chuẩn bị", TextToSpeech.QUEUE_FLUSH, null);
    }
    public void chucmung(){
        tts.speak("Chúc mừng. Bạn đã hoàn thành xong bài tập ngày hôm nay", TextToSpeech.QUEUE_FLUSH, null);
    }
    public void nghi(){
        tts.speak("Nghỉ", TextToSpeech.QUEUE_FLUSH, null);
    }
